...
public class ArrayList_LoopPractice {
    ...
    public static void main(String[] args) {
      ...
      //  System.out.println("longestName = " + longestName);
        ...
        // and check whether character count equal to the longest word character count
        ...
        // VS size() : counting the elements inside ArrayList object, it's a method of List object
