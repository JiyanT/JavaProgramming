package officeHour;  // package is just like a folder in your file system
...
public class Practice_11_12 {
    ...
    public static void main(String[] args) {
     ...
     // System.out.println( " `     ```the game score now is :  100   message count is  3000 ) ;
