...
public class MethodWithReturnPractice2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getDaysOfTheWeekFromNumber(10) ) ;
        ...
        for (int eachCode: allCodes ){
            System.out.println("eachCode = " + getDaysOfTheWeekFromNumber(eachCode));
        }
     ...
     *         if the number is within 1-7 return FUNDAY!
     */
