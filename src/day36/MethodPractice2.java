...
//        String str2 = null ;
    ...
    public static void swampFirstAndLastValue(long[] nums) {
        // just like swapping the tea in the tea cup with coffee in the coffee cup
        // you need temporary cup to hold you tea , so you can put your coffee in
