...
public class MethodPractice {
    ...
    /**
     * write a static method to accept a String and return Boolean(Yes Boolean)
     * it should be return true if the String contains at least one number .
     * @param str
     * @return true Boolean if the String contains at least one number
     */
