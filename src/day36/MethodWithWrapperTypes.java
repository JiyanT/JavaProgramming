...
public class MethodWithWrapperTypes {
    ...
    public static void main(String[] args) {
        ...
        // I's expecting 2 Integer object,
        // and we used Integer.valueOf to provide 2 Integer Object
        ...
        sumAndPrint(23,10) ;
        System.out.println("----------method with in parameter----------");
    ...
    public static void sumAndPrint( Integer num1 , Integer num2 ) {
        ...
        // compiler will turn num1 and num2 into, so it can add them numerically
    ...
    /**
     * This method will print thew doubled value of what user passed
     * @param x
     * @return
     */
