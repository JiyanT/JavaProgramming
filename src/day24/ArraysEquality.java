...
public class ArraysEquality {
    public static void main(String[] args) {
        ...
        int[] scores4 = {6,5,6,7,3,2,34,} ; // it has sam numbers as 3 but different order
        ...
        System.out.println("is Score 1 has same content as score 2 = " + isS1S2Equals ) ;

        boolean isS1S3Equals = Arrays.equals(scores1,scores3) ;
        System.out.println("is Score 1 has same content as score 3 = " + isS1S3Equals ) ;

        boolean isS3S4Equals = Arrays.equals(scores3,scores4) ;
        System.out.println("is Score 3 has same content as score 4 = " + isS3S4Equals ) ;

        System.out.println("Sorting score 3 and 4 then compare equality ");
        Arrays.sort(scores3);
        Arrays.sort(scores4);
