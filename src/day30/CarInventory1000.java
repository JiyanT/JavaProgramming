...
//                            " Car Model is : " + eachCarSplitted[1] ) ;
        ...
        // and we don't need to index so we used for each loop
        for (String eachCar : cars) {
        // we want to do this action only for one type of car brand
        // se we used start with method to check car brand
...
//                          " Car Model is : " + eachCarSplitted[1] ) ;
        ...
        System.out.println("Count of Cars with 2 character in their model = " + cntOf2CharModel);
