...
public class ForEachLoopPracticeFindMax {
    ...
    public static void main(String[] args) {
         ...
         *
         * write down the first salary as temporarily max salary on a paper
        ...
        long max2 =0 ;
        // YOU CAN NOT PICK SOMETHING THAT YOU DO NOT HAVE INSIDE ARRAY AS INITIAL VALUE
    }
}
