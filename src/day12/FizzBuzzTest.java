  ...
  /*
      * TASK 3 :
        ...
        Given a number, create a variable int num
          ...
          If this number can be divided by 5 without remainder lets print
                For example 5, 15, 25, 100
          If this number can be divided by 3 without remainder lets print
                For example 3, 15, 9, 27
          If this number can be divided by both 3 and 5 lets print
